...
description: 'Create or review responsive Tailwind CSS layouts for this Next.js app. Use when creating or updating pages, layouts, or components under app/ or components/ (page.js, loading.js, error.js, template.js, layout.js, and any .js/.jsx component), fixing mobile issues, adapting desktop-first pages for phones and laptops, auditing overflow, or improving forms, tables, navigation, or sidebar behavior across breakpoints.'
paths:
  - "app/layout.js"
  - "app/**/page.js"
  - "app/**/loading.js"
...
This skill produces implementation guidance for responsive UI work in this repository so pages remain usable on mobile phones and laptops without redefining the visual language.
...
Use this skill when creating or updating any of the following, or when a page/component has one of the listed problems:

**Applies to:**
- `app/layout.js`
- `app/**/page.js`, `app/**/loading.js`, `app/**/error.js`, `app/**/template.js`
...
## Core Rules (apply from the first draft, not as cleanup)
...
For this repository specifically, review the app shell first when a page feels cramped because the sidebar can be the root constraint.
